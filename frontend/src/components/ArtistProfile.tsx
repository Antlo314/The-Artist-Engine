        ...
        <div className="h-full flex flex-col p-6 lg:p-12 overflow-hidden relative group">
            ...
            <div className="z-10 relative flex flex-col h-full space-y-8">
                ...
                <div className="flex flex-col border-b border-white/10 pb-6">
                    <h1 className="font-display text-4xl lg:text-5xl font-bold text-ink-50 tracking-[0.2em] uppercase flex items-center gap-4">
                        <Fingerprint className="text-yellow-500" size={36} />
                        SOVEREIGN IDENTITY
                    </h1>
                    <div className="mt-2 flex flex-col sm:flex-row sm:items-center gap-3">
                        <div className="h-px w-12 bg-yellow-500/50 hidden sm:block" />
                        <p className="font-mono text-[10px] lg:text-xs text-yellow-500/70 tracking-[0.3em] uppercase">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 flex-1 overflow-y-auto custom-scrollbar pr-2 pb-24 lg:pb-0">
                    ...
                    >
                        <div className="glass-obsidian p-8 rounded-2xl border-yellow-500/30 flex flex-col items-center justify-center text-center relative overflow-hidden group/card shadow-[0_0_30px_rgba(234,179,8,0.05)]">
                            ...
                            >
                                ...
                                <div className="absolute inset-0 bg-black/60 flex items-center justify-center opacity-0 hover:opacity-100 transition-opacity">
                                    <span className="font-mono text-xs text-ink-50 tracking-widest">CHANGE</span>
                                </div>
                                <input
                                    type="file"
                                    ref={fileInputRef}
                            ...
                            <div className="w-full relative z-10 space-y-4 text-left">
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="w-full bg-ink-900 border-b border-yellow-500/30 text-ink-50 font-display text-xl text-center py-2 px-4 focus:outline-none focus:border-yellow-400 focus:bg-yellow-900/10 transition-all placeholder:text-ink-400 tracking-widest"
                                    />
                                </div>
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className="w-full bg-ink-900 border border-yellow-500/20 text-ink-50 font-inter text-sm py-2 px-3 rounded focus:outline-none focus:border-yellow-400 focus:bg-yellow-900/10 transition-all placeholder:text-ink-400"
                                        />
                                    </div>
                                    <div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        <label className="font-mono text-[9px] text-yellow-500/70 uppercase tracking-widest pl-2 mb-1 block">Fiat Treasury (USD)</label>
                                        <input
                                            type="text"
                                    ...
                                    <div>
                                        <label className="font-mono text-[9px] text-yellow-500/70 uppercase tracking-widest pl-2 mb-1 block">Crypto Treasury (ETH)</label>
                                        <input
                                            type="text"
                                ...
                                <div>
                                    <label className="font-mono text-[9px] text-yellow-500/70 uppercase tracking-widest pl-2 mb-1 block mt-4">On-Chain Payout Address</label>
                                    <input
                                        type="text"
                                        value={profile.cryptoAddress || ''}
                                        onChange={(e) => setProfile({ ...profile, cryptoAddress: e.target.value })}
                                        placeholder="0x..."
                                        className="w-full bg-ink-900 border border-yellow-500/20 text-ink-50 font-inter text-sm py-2 px-3 rounded focus:outline-none focus:border-yellow-400 focus:bg-yellow-900/10 transition-all placeholder:text-ink-400 mb-4 font-mono"
                                    />
                                </div>
                                <div>
                                ...
                                <button
                                    onClick={handleSave}
                                    className="w-full mt-4 bg-yellow-900/30 hover:bg-yellow-500 hover:text-ink-950 border border-yellow-500/50 text-yellow-500 transition-all py-3 rounded uppercase font-mono text-xs tracking-widest font-bold flex items-center justify-center gap-2"
                                >
                            ...
                            {/* Status Pill */}
                            <div className="mt-6 inline-flex items-center gap-2 bg-yellow-900/10 border border-yellow-500/30 px-3 py-1 rounded-full">
                        ...
                        {/* Quick Stats Summary */}
                        <div className="glass-obsidian p-6 rounded-2xl border-white/10 space-y-4">
                            <h3 className="font-mono text-xs text-ink-200 tracking-widest uppercase mb-4 border-b border-white/10 pb-2">
                                Identity Verification
                            </h3>
                            <div className="flex items-center justify-between text-sm">
                                <span className="font-mono text-ink-200">Tier Status:</span>
                                <span className="font-display text-ink-50 tracking-wider flex items-center gap-1">
                                    <Star size={14} className="text-yellow-500" /> OMEGA
                                </span>
                            </div>
                            <div className="flex items-center justify-between text-sm">
                                <span className="font-mono text-ink-200">Member Since:</span>
                                <span className="font-mono text-ink-50 tracking-widest">2026.03</span>
                            </div>
                            <div className="flex items-center justify-between text-sm">
                                <span className="font-mono text-ink-200">Network Sync:</span>
                    ...
                    <div className="lg:col-span-8 flex flex-col gap-8">
                        ...
                        >
                            <div className="glass-obsidian glass-obsidian-hover p-6 rounded-xl border-l-2 border-yellow-500 flex flex-col justify-between group/stat hover:bg-yellow-900/10 transition-colors">
                                <div className="flex justify-between items-start mb-4">
                                    <h4 className="font-mono text-xs text-ink-200 tracking-widest uppercase">Total Gigs Secured</h4>
                                    <TrendingUp size={16} className="text-yellow-500" />
                                </div>
                                <div className="flex items-baseline gap-2">
                                    <span className="font-display text-4xl text-ink-50">124</span>
                            ...
                            <div className="glass-obsidian glass-obsidian-hover p-6 rounded-xl border-l-2 border-yellow-500 flex flex-col justify-between group/stat hover:bg-yellow-900/10 transition-colors">
                                <div className="flex justify-between items-start mb-4">
                                    <h4 className="font-mono text-xs text-ink-200 tracking-widest uppercase">Contracts Nullified</h4>
                                    <ShieldAlert size={16} className="text-yellow-500" />
                                </div>
                                <div className="flex items-baseline gap-2">
                                    <span className="font-display text-4xl text-ink-50">8</span>
                                    <span className="font-mono text-[10px] text-ink-400 uppercase tracking-widest">Via Zion Sentinel</span>
                                </div>
                            </div>
                        </motion.div>
                        ...
                        <motion.div
                            ...
                            className="glass-obsidian rounded-2xl border-white/10 flex-1 p-8 relative overflow-hidden flex flex-col"
                        >
                            ...
                            <div className="flex items-center gap-3 mb-8">
                                ...
                                <h3 className="font-display text-2xl text-ink-50 tracking-[0.1em] uppercase">Premium Arsenal</h3>
                            </div>

                            <p className="font-mono text-xs text-ink-200 tracking-widest uppercase mb-8 leading-relaxed max-w-2xl">
                                Access elite-tier tools and global industry intelligence. Unlock the full potential of the Sovereign Ecosystem.
                            </p>

                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 flex-1">
                                {/* Locked Feature 1 */}
                                <div className="bg-black/40 border border-white/10 rounded-xl p-6 relative group/locked overflow-hidden">
                                    ...
                                    <div className="relative z-10 flex flex-col h-full">
                                        <div className="flex justify-between items-start mb-4">
                                            <div className="w-10 h-10 rounded-lg bg-white/5 flex items-center justify-center">
                                                <Fingerprint className="text-ink-200" size={20} />
                                            </div>
                                            <Lock size={16} className="text-ink-400" />
                                        </div>
                                        <h4 className="font-display text-lg text-ink-50 mb-2">Global Routing Intelligence</h4>
                                        <p className="font-mono text-[10px] text-ink-400 leading-relaxed mb-6 flex-1">
                                ...
                                <div className="bg-black/40 border border-white/10 rounded-xl p-6 relative group/locked overflow-hidden">
                                    ...
                                    <div className="relative z-10 flex flex-col h-full">
                                        <div className="flex justify-between items-start mb-4">
                                            <div className="w-10 h-10 rounded-lg bg-white/5 flex items-center justify-center">
                                                <Zap className="text-ink-200" size={20} />
                                            </div>
                                            <Lock size={16} className="text-ink-400" />
                                        </div>
                                        <h4 className="font-display text-lg text-ink-50 mb-2">Sync Licensing Oracle</h4>
                                        <p className="font-mono text-[10px] text-ink-400 leading-relaxed mb-6 flex-1">
                            ...
                            <div className="mt-8 pt-6 border-t border-white/10 flex justify-center">
                                <button className="px-8 py-3 bg-white/5 hover:bg-yellow-500 hover:text-ink-950 text-yellow-500 border border-yellow-500/50 hover:border-yellow-500 transition-all font-display tracking-widest text-sm rounded-lg shadow-[0_0_15px_rgba(234,179,8,0)] hover:shadow-[0_0_20px_rgba(234,179,8,0.4)] block w-full sm:w-auto text-center font-bold">
